...
def chunk_text(text: str, chunk_size=500, overlap=50, batch_size=100) -> Generator[List[str], None, None]:
    """Chunk text into smaller pieces, yielding batches to reduce memory usage."""
